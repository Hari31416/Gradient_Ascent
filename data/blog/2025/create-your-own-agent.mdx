...
job_description_agent = ManagedAgent(
    ...
    description="Have a knack of finding the relavant information from a job description. Can scrape the job description from a LinkedIn job posting and summarize its contents.",
)
